            ...
            <section className="w-full py-20 mb-20 px-3 lg:px-10 bg-background">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-lg transition-shadow">
                        ...
                        <h2 className="text-2xl md:text-3xl font-medium text-foreground mb-4">Partner with us</h2>
                        <p className="text-foreground mb-8 leading-relaxed">
                            We work in all things creative and strategy, and look forward to discussing your project.
                        </p>
                        <a 
                            href="/contact" 
                            className="w-full inline-flex items-center justify-center gap-2 bg-primary text-white px-6 py-4 rounded-full font-medium hover:bg-blue-700 transition-colors"
                        >
                            Contact Us
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-lg transition-shadow">
                        ...
                        <h2 className="text-2xl md:text-3xl font-medium text-foreground mb-4">Stay informed.</h2>
                        <p className="text-foreground mb-8 leading-relaxed">
                            Sign up to our newsletter for a global view on design and technology.
                        </p>
                        <a 
                            href="/contact" 
                            className="w-full inline-flex items-center justify-center gap-2 bg-primary text-white px-6 py-4 rounded-full font-medium  transition-colors"
                        >
                            Subscribe
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <line x1="7" y1="17" x2="17" y2="7"></line>
