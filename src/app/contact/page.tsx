          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="space-y-6 pt-8 border-t border-[#E3E3E3]">
              ...
              <Button 
                variant="nav-contact"
                size="nav-contact"
                className="bg-background border border-foreground text-foreground hover:bg-foreground hover:text-white rounded-full px-8 py-4  transition-all duration-300"
              >
                Book A Meeting
