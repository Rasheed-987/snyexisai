...
const service = () => {
  return (
<section className='w-full h-[100vh] py-16   bg-white mb-30  relative '>
<div>
    <h2 className="text-[#1A2341] text-3xl text-center sm:text-4xl lg:text-5xl font-medium leading-tight mb-20">Our Services</h2>
</div>
