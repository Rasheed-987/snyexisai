...
export default function StickyContact() {
  return (
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[100] flex flex-col gap-3 md:gap-4">
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/971565574998" // Replace with actual WhatsApp number
        target="_blank"
        rel="noopener noreferrer"
        className="group flex h-10 w-10 md:h-14 md:w-14 items-center justify-center rounded-full bg-white shadow-lg transition-transform hover:scale-110 hover:shadow-xl"
        aria-label="Contact on WhatsApp"
      >
        <svg
          viewBox="0 0 24 24"
          className="h-6 w-6 md:h-8 md:w-8 fill-[#25D366]"
