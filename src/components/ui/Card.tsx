...
export function JobCard({ id, title, location, company, type, description }: JobCardProps) {
  return (
    <div className="bg-white border border-[#D2D2D2] rounded-[32px] shadow-sm p-6 sm:p-10 w-full max-w-md sm:max-w-3xl mx-auto flex flex-col gap-4 sm:gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-2 sm:mt-6">
        <button
